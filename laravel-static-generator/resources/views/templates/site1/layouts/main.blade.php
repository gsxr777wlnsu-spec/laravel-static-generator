...
@php
            ...
            $pageLocale = $languageService->normalizeLocale((string) ($page->locale ?? $site->locale ?? 'en')) ?: 'en';
            $siteMenuHtml = $languageService->menuWithLanguageSwitcher($layoutContent->resolveMenuInner($site, $pageLocale), $page, $site);
            $siteMobileMenuHtml = $layoutContent->resolveMobileMenuHtml($site, $pageLocale);
            $siteFooterHtml = $layoutContent->resolveFooterInner($site, $pageLocale);
