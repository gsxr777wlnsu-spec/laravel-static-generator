                ...
                <li class="menu__item menu__item--has-submenu menu__item--lang lang-item lang-item-en">
                    <a class="menu__link menu__link--lang" href="#" aria-haspopup="true" aria-expanded="false" data-desktop-submenu-trigger>
                        <span class="menu__lang">
                            <img class="menu__lang-flag" src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAALCAIAAAD5gJpuAAAASklEQVR42mM4IaD3//9/RsVMOAJygYK4xBkwpfGLMCALQVSgaUCWAiIGrC7BZMCVgZyECeDqMAEDRI54RLoNJPuB5FAiOR5IjWkAJLMivBWX4NUAAAAASUVORK5CYII=" alt="" width="16" height="11" loading="lazy">
